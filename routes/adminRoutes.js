...
router.post('/country-add', authenticationMiddleware.authenticateArtistRequestAPI, validateRequest.validate(adminValidationSchema.addCountrySchema, 'body'), adminController.addCountry); // Add Country
router.get('/country-list', authenticationMiddleware.authenticateArtistRequestAPI, validateRequest.validate(adminValidationSchema.listCountrySchema, 'query'), adminController.listCountry); // List Country
router.put('/country-status-change/:id', authenticationMiddleware.authenticateArtistRequestAPI, adminController.statusChangeCountry); // Country Status Change
router.post('/genre-add', authenticationMiddleware.authenticateArtistRequestAPI, validateRequest.validate(adminValidationSchema.addGenreSchema, 'body'), adminController.addGenre); // Add Genre
router.get('/genre-list', authenticationMiddleware.authenticateArtistRequestAPI, validateRequest.validate(adminValidationSchema.listCountrySchema, 'query'), adminController.listGenre); // List Genre
router.delete('/delete-genre/:id', authenticationMiddleware.authenticateArtistRequestAPI, adminController.deleteGenre); // Delete Genre
...
router.get('/artist-details/:id', authenticationMiddleware.authenticateArtistRequestAPI, adminController.artistDetails); // Artists Details
